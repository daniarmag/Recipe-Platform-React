            ...
            {recipeData ? (
                <>
                    <form className="max-w-md mx-auto pb-4" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4 mx-4">
                            <label htmlFor="preparation" className="block text-lg font-semibold text-gray-700">
                            PREPARATION
                            </label>
                            <textarea
                                id="preparation"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div className="mb-2 mx-4">
                                <label htmlFor="fat" className="block text-lg font-semibold text-gray-700">
                                FAT
                                </label>
                                <textarea
                            ...
                            <div className="mb-2 mx-4">
                                <label htmlFor="proteins" className="block text-lg font-semibold text-gray-700">
                                PROTEINS
                                </label>
                                <textarea
